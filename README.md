...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-v32qyg4.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-v32qyg4.containers.anotherwebservice.com/
...
```
git clone git@github.com:ParvathiRNair/container-v32qyg4.git
cd container-v32qyg4
```
...
```
docker attach container-v32qyg4
```
